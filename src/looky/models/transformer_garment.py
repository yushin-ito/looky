...
class GarmentAttnProcessor2_0:
    """Attention processor used typically in processing the SD3-like self-attention projections."""

    def __init__(self):
        if not hasattr(F, "scaled_dot_product_attention"):
            raise ImportError(
                "GarmentAttnProcessor2_0 requires PyTorch 2.0, to use it, please upgrade PyTorch to 2.0."
            )
...
class GarmentTransformerBlock(nn.Module):
    r"""
    ...
    def __init__(
        ...
        if hasattr(F, "scaled_dot_product_attention"):
            processor = GarmentAttnProcessor2_0()
        else:
            raise ValueError(
...
class GarmentTransformer2DModel(
    ModelMixin,
    ConfigMixin,
    PeftAdapterMixin,
    FromOriginalModelMixin,
    ...
    _no_split_modules = ["GarmentTransformerBlock"]
    ...
    def forward(
        ...
        """
        The [`GarmentTransformer2DModel`] forward method.
